<template>
  <section class="dashboard">
    <main class="content">
      ...
      <div class="card">
        <h2>Bienvenue</h2>
        <p>Vous êtes connecté. Ceci est votre tableau de bord.</p>
      </div>
    </main>

    <nav class="mobile-nav">
      <RouterLink to="/dashboard" class="nav-btn is-active">
        <svg class="i" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path fill="currentColor" d="M12 3l9 7v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V10l9-7Z"/>
        </svg>
        <span>Tableau</span>
      </RouterLink>
      <RouterLink to="/notifications" class="nav-btn">
        <svg class="i" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path fill="currentColor" d="M12 22a1.5 1.5 0 0 0 1.5-1.5v-1.02a7.8 7.8 0 0 0 3.21-1.33l.84.49a1.5 1.5 0 0 0 2.05-.55l1.5-2.6a1.5 1.5 0 0 0-.55-2.05l-.86-.5a8.08 8.08 0 0 0 0-2.66l.86-.5a1.5 1.5 0 0 0 .55-2.05l-1.5-2.6a1.5 1.5 0 0 0-2.05-.55l-.84.49A7.8 7.8 0 0 0 13.5 4.5V3.5A1.5 1.5 0 0 0 12 2a1.5 1.5 0 0 0-1.5 1.5v1.02A7.8 7.8 0 0 0 7.29 6.35l-.84-.49a1.5 1.5 0 0 0-2.05.55l-1.5 2.6a1.5 1.5 0 0 0 .55 2.05l.86.5a8.08 8.08 0 0 0 0 2.66l-.86.5a1.5 1.5 0 0 0-.55 2.05l1.5 2.6a1.5 1.5 0 0 0 2.05.55l.84-.49a7.8 7.8 0 0 0 3.21 1.33v1.02A1.5 1.5 0 0 0 12 22Zm0-6.5A3.5 3.5 0 1 1 12 8a3.5 3.5 0 0 1 0 7.5Z"/>
        </svg>
        <span>Notifications</span>
      </RouterLink>
      <RouterLink to="/new" class="nav-btn" aria-label="Nouveau site">
        <svg class="i" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path fill="currentColor" d="M11 5a1 1 0 0 1 1 1v4h4a1 1 0 1 1 0 2h-4v4a1 1 0 1 1-2 0v-4H6a1 1 0 1 1 0-2h4V6a1 1 0 0 1 1-1Z"/>
        </svg>
        <span>Créer une clé</span>
      </RouterLink>
      <RouterLink to="/teams" class="nav-btn">
        <svg class="i" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path fill="currentColor" d="M16 11a4 4 0 1 0-8 0 4 4 0 0 0 8 0ZM3 20a7 7 0 0 1 14 0v1H3v-1Zm18-9h-2V9h2V7h2v2h2v2h-2v2h-2v-2Z"/>
        </svg>
        <span>Équipes</span>
      </RouterLink>
...
.icon-btn {
  ...
  color: #f97316; box-shadow: 0 6px 18px rgba(249,115,22,0.18);
}
...
.card h2 { font-size: 1.1rem; font-weight: 800; }
.card p { color: #b7c1cd; }
...
.nav-btn span { font-size: .72rem; margin-top: .25rem; white-space: nowrap; }
